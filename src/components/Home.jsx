...
function Home() {
    ...
    let arr = ["Enhance fortune 50 company's insights teams research capabilities","Implement advanced data analytics tools to extract actionable insights","Develop cutting-edge ML algorithms to predict future market trends"]
  ...
  return (
    <div className='flex flex-col justify-center items-center min-h-[220vh] relative'>
        ...
        <div className='m-10 pt-3'>
            ...
            <div className='flex justify-center items-center crop-container relative space-x-48'>
                ...
                <div className='absolute bottom-16 right-[970px] shadow-xl bg-white rounded-full w-56 h-16 flex justify-center items-center'>
                ...
                <div className='absolute top-20 right-[1000px] w-48 shadow-2xl rounded-2xl bg-white flex justify-center items-center h-48'>
                ...
                <div className='absolute right-[700px] bottom-2 shadow-xl bg-green-950 w-56 h-44 rounded-3xl flex flex-col justify-center items-center'>
            ...
            <div className='flex rounded-3xl bg-[#E8EEE7] p-20 mt-24 w-[95vw] mx-auto'>
                <div className='flex flex-col justify-between items-center'>
                    ...
                    <img className='h-96' src={Stroke} alt="" />
                </div>
                <div className='accordion w-52'>
                <div className="w-[35rem]" style={{fontFamily:"Manrope"}}>
                    <Accordion
